...
static const Parser_action_table<Non_terminal> action_table = {
...
const SLR_parser_tables<Expr_lex_traits> expr_slr_tables =
    {rules, goto_table, &action_table};